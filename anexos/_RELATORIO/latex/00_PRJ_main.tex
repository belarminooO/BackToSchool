...
\usepackage[utf8]{inputenc} % no "www.overleaf.com" | no Unix (com codificação UTF-8) | 
...
%%________________________________________________________________________
% definir espaço antes e depois das legendas (e.g., de tabelas e figuras)
%%________________________________________________________________________
...
\backmatter
%% as referencias correspondem a ferramentas, bibliotecas e jogos citados
%% ao longo do texto; \nocite{*} garante que todas surgem na Bibliografia
\nocite{*}
\bibliography{XBib}
