...
public class RoundTimerManager : MonoBehaviour
{
    ...
    [Header("State Colors")]
    [SerializeField] private Color freezeColor = new Color(0.8f, 0.8f, 0.8f); 
    [SerializeField] private Color questionColor = new Color(0.20f, 0.60f, 1.00f); 
    [SerializeField] private Color obstacleColor = new Color(0.20f, 0.85f, 0.30f); 
    [SerializeField] private Color changeColor = new Color(0.8f, 0.8f, 0.8f); 
