...
![Lobby do jogo](docs/figures/LobbyImage.png)
...
<video src="https://github.com/belarminooO/BackToSchool/releases/download/v1.0.0/BackToSchoolVideo.mp4" controls="controls" style="max-width: 100%;"></video>
